---
name: architect
description: 從產品角度提出技術方向建議，供 RD 團隊參考。包含產品技術約束、技術方向偏好、概念資料模型和第三方服務需求。當使用者提到「技術建議」、「技術方向」、「給 RD 的技術備忘」、「要用什麼技術」、「需要串什麼服務」，或是設計稿完成準備交接給 RD 時，都應觸發此 Skill。此 Skill 的產出為建議性質，最終技術決策權在 RD。
---
